...
from utils.general import non_max_suppression, scale_coords, check_file, check_img_size, check_suffix, check_dataset, colorstr, check_yaml
...
def pseudolabel(
    ...
    for batch_i, (img, targets, paths, shapes) in tqdm(enumerate(dataloader), desc="PseudoLabel", mininterval=0.01):
        ...
        output = non_max_suppression(out, conf_thres, iou_thres, labels=lb, multi_label=True, agnostic=single_cls)
